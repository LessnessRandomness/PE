...
Module Info.
  ...
  Definition source_file := "EulerProject4.c".
...
Definition _is_palindrome : ident := $"is_palindrome".
...
(Ssequence
  (Sifthenelse (Ebinop One
                 (Ebinop Odiv (Etempvar _n tuint)
                   (Econst_int (Int.repr 100000) tint) tuint)
                 (Ebinop Omod (Etempvar _n tuint)
                   (Econst_int (Int.repr 10) tint) tuint) tint)
  ...
  (Ssequence
    (Sifthenelse (Ebinop One
                   (Ebinop Omod
                     (Ebinop Odiv (Etempvar _n tuint)
                       (Econst_int (Int.repr 10000) tint) tuint)
    ...
    (Ssequence
      (Sifthenelse (Ebinop One
                     (Ebinop Omod
                       (Ebinop Odiv (Etempvar _n tuint)
                         (Econst_int (Int.repr 1000) tint) tuint)
                       (Econst_int (Int.repr 10) tint) tuint)
                     (Ebinop Omod
                       (Ebinop Odiv (Etempvar _n tuint)
                         (Econst_int (Int.repr 100) tint) tuint)
                       (Econst_int (Int.repr 10) tint) tuint) tint)
        (Sreturn (Some (Econst_int (Int.repr 0) tint)))
        Sskip)
...
((___compcert_va_int32,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     (tint :: nil) tvoid
     {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|})) ::
 (_is_palindrome, Gfun(Internal f_is_palindrome)) ::
 (_find, Gfun(Internal f_find)) :: (_main, Gfun(Internal f_main)) :: nil).

Definition public_idents : list ident :=
(_main :: _find :: _is_palindrome :: ___builtin_debug ::
